  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mt-8 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          <SaveProgressButton status={saveStatus} onClick={() => onSave(formData)} />
          <button
            type="submit"
            className="bg-[#c653a0] text-white py-2 px-8 rounded-lg font-bold hover:opacity-90 transition-opacity"
          >
            Continue →
          </button>
        </div>
