...
Settings subscriptions, tiered pricing

Standard
£249 per setting per month
Includes core operations, compliance basics, and basic reporting

Multi site
£249 per group per month, add locations at £99 per location per month
Includes group dashboard and bulk admin tools

Enterprise
Enterprise uplift on top of Standard or Multi site pricing
Includes advanced governance, approval workflows, audit, reporting suite, integrations, and priority support
...
Annual plan option
Pay 10 months equivalent per year
